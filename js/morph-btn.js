...
(function () {
  ...
  SVGButton.prototype.initEvents = function () {
    this.el.addEventListener("mouseenter", this.down.bind(this));
    ...
    this.el.addEventListener("mouseleave", this.up.bind(this));
  };
  ...
  SVGButton.prototype.down = function () {
    this.pathEl
      ...
      .animate(
        ...
        this.options.speed.active,
        this.options.easing.active
      );
  };
  ...
  SVGButton.prototype.up = function () {
    this.pathEl
      ...
      .animate(
        ...
        this.options.speed.reset,
        this.options.easing.reset
      );
  };

  [].slice
    .call(document.querySelectorAll("button.button--effect-1"))
    .forEach(function (el) {
      new SVGButton(el);
    });

  [].slice
    .call(document.querySelectorAll("button.button--effect-2"))
    .forEach(function (el) {
      new SVGButton(el, {
